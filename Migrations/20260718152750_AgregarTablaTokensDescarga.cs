...
{
    /// <inheritdoc />
    public partial class AgregarTablaTokensDescarga : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TokensDescarga", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TokensDescarga_Productos_ProductoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TokensDescarga_ProductoId",
                table: "TokensDescarga",
                column: "ProductoId");
        }
